void Interface1()
{
    ...
    glColor3f(1.0, 1.0, 1.0);// Set line segment color as glColor3f(R,G,B)
    glBegin(GL_POLYGON);
    glVertex2i(470, 347); // Right Middle
    glVertex2i(495, 380); // Right Top
    glVertex2i(300, 380); // Left Top
    glVertex2i(325, 347); // Left Middle
    glVertex2i(300, 313); // Left Bottom
    glVertex2i(495, 313); // Right Bottom
    glEnd();
